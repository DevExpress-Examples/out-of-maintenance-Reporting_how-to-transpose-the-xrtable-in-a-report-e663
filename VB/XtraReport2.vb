            ...
            If db.Position * 5 < db.Count Then
                ...
                For i As Integer = 0 To 4
                    ...
                    If (db.Current IsNot Nothing) AndAlso prevpos <> db.Position Then
                        ...
                        Dim byte_Picture() As Byte = DirectCast(dr(3), Byte())
                        ...
                        Dim im As Image = Image.FromStream(stream_Picture)
                        CType(Me.xrTable1.Rows(3).Cells(i + 1).Controls(0), XRPictureBox).Image = im
