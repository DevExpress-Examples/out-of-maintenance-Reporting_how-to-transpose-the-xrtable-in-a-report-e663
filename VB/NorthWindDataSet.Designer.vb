...
Namespace TransposeXRTable
    ...
    End Class
End Namespace
Namespace TransposeXRTable.NorthWindDataSetTableAdapters
    ...
    Partial Public Class CategoriesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([CategoryName], [Description], [Picture]) VALUES " & "(@CategoryName, @Description, @Picture);" & ControlChars.CrLf & "SELECT CategoryID, CategoryName, Descr" & "iption, Picture FROM Categories WHERE (CategoryID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Categories] SET [CategoryName] = @CategoryName, [Description] = @Description, [Picture] = @Picture WHERE (([CategoryID] = @Original_CategoryID) AND ([CategoryName] = @Original_CategoryName));" & ControlChars.CrLf & _
"SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)"
        ...
        Public Overridable Function Update(ByVal CategoryName As String, ByVal Description As String, ByVal Picture() As Byte, ByVal Original_CategoryID As Integer, ByVal Original_CategoryName As String, ByVal CategoryID As Integer) As Integer
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(CategoryID))
